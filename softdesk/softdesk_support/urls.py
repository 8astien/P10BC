...
urlpatterns = [
    ...
    path('api/projects/<int:pk>/add-contributor/', add_collaborator),
    path('api/projects/<int:pk>/delete-contributor/', delete_collaborator),
    ...
    path(
        'api/projects/<int:pk>/issues/<int:pk2>/change-status/',
        change_status
    ),
    path(
        'api/projects/<int:pk>/issues/<int:pk2>/assign-contributor/',
        assign_contributor
    ),
    ...
    path(
        'api/users/<int:pk>/projects/<int:pk2>/issues/',
